...
var featuredimagezoomer={
	...
	init:function($, $img, options){
		...
		$img.one('mouseover', function(e){
			...
			//alert($img.attr('src').substring(0,$img.attr('src').indexOf('.jpg',0)+4));
			//var $bigimage=$('<img src="'+($img.attr('src').substring(0,$img.attr('src').indexOf('.jpg',0)+4) + '&amp;maxWidth=1000')+'"/>').appendTo($maginner)
...
jQuery.fn.addimagezoom=function(options){
	var $=jQuery;
	//alert('featuredimagezoomer.js ln181');
