...
@Entity
public class CompetitionWinnerEmail extends SourceGeneratedEmailTemplate<CompetitionPrizeWinner> {

	private static final long serialVersionUID = 727058876766443021L;

	public CompetitionWinnerEmail() {
	}
	...
	public String getDefaultSubject() {
		return "Congratulations from {COMPANY_NAME} - You're a competition winner!";
	}
	...
	public String getDefaultContent() {
		return loadBodyFromFile( "competitionWinnerEmail.html" );
	}
	...
	public EmailTemplateEnum getEmailTemplateEnum() {
		return CmsEmailTemplateEnum.COMPETITION_WINNER;
	}
